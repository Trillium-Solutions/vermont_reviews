    ...
    <div class="container">
        ...
        <div class="instructions-box">
            ...
            <ul style="margin-bottom:0; padding-left: 20px;">
                ...
                <li><strong>Important:</strong> If a change is related to a <strong>GTFS schedule change</strong>, please email <a href="mailto:trillium.support@optibus.com">trillium.support@optibus.com</a> immediately.</li>
            </ul>
        </div>
